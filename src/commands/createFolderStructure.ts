...
import { FolderTemplate, StringReplaceTuple } from "../types/index.js";

import {
  getLocalTemplatePath,
  getTargetPath,
  readConfig,
} from "../lib/vscodeHelpers.js";
import { showError, showInfo } from "../lib/vscodeHelpers.js";
import { getTemplatesFromFS, pickTemplate } from "../lib/extensionHelpers.js";
import { isDirectory } from "../lib/fsHelpers.js";
import { getReplaceValueTuples } from "../lib/getReplaceValueTuples.js";
import createStructure from "../actions/createStructure.js";
